...
namespace jamupark
{
    internal abstract class Jarmu
    {
        ...
        {
            Object[] obj = { this.GetType().Name.ToLower(), Azonosito, Rendszam, Kor(), Fogyasztas, FutottKm };
    ...
    {
        private List<Jarmu> jarmuvek = new List<Jarmu>(); private string BUSZ = "busz";
        ...
        private void AdatBevitel()
        {
            ...
            StreamReader olvasoCsatorna = new StreamReader("d:/buszok.txt");
            int sorszam = 1;
